...
/******************PRINT PERCENT SIGN******************/
/**
 * print_percent - prints a prcent sign
 ...
 * Return: Number of chars printed
 */
int print_percnt(va_list types, char buffer[], int flags, int width, int precision, int size);
{
	UNUSED(types);
	UNUSED(buffer);
	UNUSED(flags);
